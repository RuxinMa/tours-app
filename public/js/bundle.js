...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var stripe, session, bookBtn, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          stripe = Stripe('pk_test_51RrYcPJrB7RpIx6XgIPLLq0VQ1PLRJddCQRHaeEBGRKQhrmQCR2SSFwwEdec64BZSJFHyGKIAumjCdGGYKXDkHFY00treFTE7T'); // Public Stripe key
...
if (mapBox) {
  ...
  (0, _mapbox.displayMap)(locations); // Call the function to display the map with locations
}
if (loginForm) {
  ...
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(email, password); // Call the login function with email and password
  });
}
if (logoutBtn) {
  ...
  logoutBtn.addEventListener('click', function (e) {
    ...
    (0, _login.logout)(); // Call the logout function to log the user out
  });
}
if (userDataForm) {
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    try {
      ...
      var tourId = e.target.dataset.tourId; // Use the dataset property to get the tour ID
